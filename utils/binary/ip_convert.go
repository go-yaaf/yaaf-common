...
// IPv6ToInt converts IP address of version 6 from net.IP to uint64 array representation.
// Return value contains high integer value on the first place and low integer value on second place.
